### In a Nutshell
My config is a hybrid and slightly reduced version of Zabooby's and Ujjwal-dev23's 

### Black Magic
Despite having absolute windows paths in Zabooby's part the config works flawlessly on linux. Nothing I use seems broken. I have no idea why.

### Small Thing
Kindly change gpu-api to vulkun (or is it vulkan?)
...
I didn't set any path because I just use prtscr
